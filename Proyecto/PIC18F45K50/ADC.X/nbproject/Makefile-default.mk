...
SOURCEFILES_QUOTED_IF_SPACED=adc.s
...
FINAL_IMAGE_NAME_MINUS_EXTENSION=${DISTDIR}/ADC.X.${IMAGE_TYPE}
# ------------------------------------------------------------------------------------
...
${DISTDIR}/ADC.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	...
	-o ${DISTDIR}/ADC.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} \
...
${DISTDIR}/ADC.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	...
	@${MP_JAVA_PATH}java -jar "C:/Program Files/Microchip/MPLABX/v6.00/mplab_platform/platform/../mplab_ide/modules/../../bin/checksum.jar" -i PIC18F45K50 ${DISTDIR}/ADC.X.${IMAGE_TYPE}.hex 2> NUL 1> NUL
